...
const Drawing = () => {
  ...
  const [colorTosaka, setColorTosaka] = React.useState({})
  ...
  return (
    ...
    <path
      ...
      fill={tosakaColor.rgba}/>
    <path
      id="left-eye-white-part"
    ...
    fill="#fff"/>
    <path
      className="right-eye outline iris"
    ...
    <path
      ...
      fill={beakColor.rgba}/>
    <path
      className="tosaka-outline mouse-outline"
